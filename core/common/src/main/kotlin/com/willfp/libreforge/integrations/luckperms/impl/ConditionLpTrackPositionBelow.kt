...
object ConditionLpTrackPositionBelow : Condition<NoCompileData>("lp_track_position_below") {
    ...
    override val arguments = arguments {
        ...
        require(
            "position",
            "You must specify the maximum position!",
            description = "The maximum position in the track.",
