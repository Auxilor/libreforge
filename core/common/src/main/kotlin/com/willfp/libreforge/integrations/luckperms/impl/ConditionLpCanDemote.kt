...
object ConditionLpCanDemote : Condition<NoCompileData>("lp_can_demote") {
    override val description = "Passes when there is a group below the primary group of the player in a LuckPerms track."
    ...
    override fun isMet(
        ...
        return track.getPrevious(group) != null
    }
}
