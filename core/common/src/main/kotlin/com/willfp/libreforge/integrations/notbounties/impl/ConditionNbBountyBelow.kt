...
object ConditionNbBountyBelow : Condition<NoCompileData>("nb_bounty_below") {
    override val description = "Passes when the total NotBounties bounty on the player is less than the specified amount."
    ...
    override val arguments = arguments {
        require(
            ...
            description = "The amount the total bounty must be less than.",
