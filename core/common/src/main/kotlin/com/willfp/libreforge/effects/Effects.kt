...
import com.willfp.libreforge.effects.impl.EffectCondenseItems
...
import com.willfp.libreforge.effects.impl.EffectFillHeldStack
...
import com.willfp.libreforge.effects.impl.EffectGrowTree
...
import com.willfp.libreforge.effects.impl.EffectKillPlayer
...
import com.willfp.libreforge.effects.impl.EffectOpenAnvil
import com.willfp.libreforge.effects.impl.EffectOpenCartographyTable
import com.willfp.libreforge.effects.impl.EffectOpenCrafting
import com.willfp.libreforge.effects.impl.EffectOpenDisposal
import com.willfp.libreforge.effects.impl.EffectOpenEnderChest
import com.willfp.libreforge.effects.impl.EffectOpenGrindstone
import com.willfp.libreforge.effects.impl.EffectOpenLoom
import com.willfp.libreforge.effects.impl.EffectOpenSmithingTable
import com.willfp.libreforge.effects.impl.EffectOpenStonecutter
...
import com.willfp.libreforge.effects.impl.EffectRemoveNearbyEntities
...
import com.willfp.libreforge.effects.impl.EffectSetGamemode
...
import com.willfp.libreforge.effects.impl.EffectSetItemLore
...
import com.willfp.libreforge.effects.impl.EffectSetTime
...
import com.willfp.libreforge.effects.impl.EffectSetWeather
...
import com.willfp.libreforge.effects.impl.EffectStripLogs
...
import com.willfp.libreforge.effects.impl.EffectTeleportToHighestBlock
import com.willfp.libreforge.effects.impl.EffectTeleportToLookingAt
import com.willfp.libreforge.effects.impl.EffectTeleportToLowestBlock
...
import com.willfp.libreforge.effects.impl.EffectWearHeldItem
...
object Effects : Registry<Effect<*>>() {
    ...
    init {
        ...
        register(EffectOpenStonecutter)
        register(EffectOpenSmithingTable)
        register(EffectOpenCartographyTable)
        register(EffectOpenDisposal)
        register(EffectTeleportToHighestBlock)
        register(EffectTeleportToLowestBlock)
        register(EffectTeleportToLookingAt)
        register(EffectSetTime)
        register(EffectSetWeather)
        register(EffectGrowTree)
        register(EffectWearHeldItem)
        register(EffectFillHeldStack)
        register(EffectCondenseItems)
        register(EffectRenameItem)
        register(EffectSetItemLore)
        register(EffectKillPlayer)
        register(EffectSetGamemode)
        register(EffectRemoveNearbyEntities)
    }
}
