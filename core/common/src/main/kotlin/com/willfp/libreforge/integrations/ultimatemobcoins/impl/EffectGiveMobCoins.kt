...
class EffectGiveMobCoins(private val plugin: UltimateMobCoinsPlugin) : Effect<NoCompileData>("give_mob_coins") {
    ...
    override val arguments = arguments {
        require("amount", "You must specify the amount of mobcoins to give!", description = "The amount of mob coins to give the player. Supports expressions.", type = ArgType.EXPRESSION)
    }
