...
object EffectFactionRemoveTnt : Effect<NoCompileData>("faction_remove_tnt") {
    override val parameters = setOf(TriggerParameter.PLAYER)

    override val arguments = arguments {
        require("amount", "You must specify the amount to remove!")
    }
    ...
    override fun onTrigger(config: Config, data: TriggerData, compileData: NoCompileData): Boolean {
        ...
        faction.removeTNT(config.getIntFromExpression("amount", data))
        return true
    }
}
