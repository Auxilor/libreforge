...
object FilterItemDurabilityAbovePercent : Filter<NoCompileData, Double>("item_durability_above_percent") {
    override val description = "Matches when the held item's remaining durability percentage is at or above the given value."
