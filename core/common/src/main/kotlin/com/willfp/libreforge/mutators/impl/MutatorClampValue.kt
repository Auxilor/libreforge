...
object MutatorClampValue : Mutator<NoCompileData>("clamp_value") {
    override val description = "Restricts the value to be between a minimum and a maximum."
    ...
    override val arguments = arguments {
        optional(
            "min",
            description = "The lowest that the value is allowed to be.",
        ...
        optional(
            "max",
            description = "The highest that the value is allowed to be.",
            type = ArgType.EXPRESSION,
            default = "Infinity",
            example = "100"
        )
    ...
    override fun mutate(data: TriggerData, config: Config, compileData: NoCompileData): TriggerData {
        ...
        return data.copy(
            value = data.value.coerceIn(min, max)
        )
    }
}
