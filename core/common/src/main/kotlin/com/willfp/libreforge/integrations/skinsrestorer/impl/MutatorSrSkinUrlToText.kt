...
object MutatorSrSkinUrlToText : Mutator<NoCompileData>("sr_skin_url_to_text") {
    override val description = "Sets the text to the texture URL of the player's skin."
    ...
    override fun mutate(data: TriggerData, config: Config, compileData: NoCompileData): TriggerData {
        ...
        return data.copy(
            text = player.lookupSkin().property?.textureUrl() ?: return data
        )
    }
}
