...
object FilterAboveHealth : Filter<NoCompileData, Double>("above_health") {
    override val description = "Matches when the victim's current health is at or above the given value."
