...
object FilterItemDurabilityBelow : Filter<NoCompileData, Int>("item_durability_below") {
    override val description = "Matches when the held item's remaining durability is at or below the given amount."
