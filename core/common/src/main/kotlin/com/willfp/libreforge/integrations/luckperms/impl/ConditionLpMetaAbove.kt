...
object ConditionLpMetaAbove : Condition<NoCompileData>("lp_meta_above") {
    override val description = "Passes when the numeric LuckPerms meta value is at or above the minimum."
    ...
    override val arguments = arguments {
        ...
        require(
            "value",
            "You must specify the minimum value!",
            description = "The minimum value the meta must have.",
