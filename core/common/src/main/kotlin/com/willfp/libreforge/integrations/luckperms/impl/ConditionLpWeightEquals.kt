...
object ConditionLpWeightEquals : Condition<NoCompileData>("lp_weight_equals") {
    override val description = "Passes when the LuckPerms weight of the player is exactly the specified value."
    ...
    override val arguments = arguments {
        require(
            "weight",
            "You must specify the weight!",
            description = "The weight the player must have.",
