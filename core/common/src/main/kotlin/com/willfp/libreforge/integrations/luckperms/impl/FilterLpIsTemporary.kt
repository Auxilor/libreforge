...
object FilterLpIsTemporary : Filter<NoCompileData, Boolean>("lp_is_temporary") {
    override val description = "Matches when the LuckPerms node in the trigger is temporary."
