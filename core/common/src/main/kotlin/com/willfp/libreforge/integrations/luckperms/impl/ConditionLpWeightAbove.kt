...
object ConditionLpWeightAbove : Condition<NoCompileData>("lp_weight_above") {
    override val description = "Passes when the LuckPerms weight of the player is at or above the minimum."
    ...
    override val arguments = arguments {
        require(
            ...
            description = "The minimum weight the player must have.",
