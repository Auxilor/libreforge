...
object FilterBelowHunger : Filter<NoCompileData, Double>("below_hunger") {
    override val description = "Matches when the victim's hunger level is at or below the given value."
