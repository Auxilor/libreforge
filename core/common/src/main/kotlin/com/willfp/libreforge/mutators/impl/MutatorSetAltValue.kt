...
object MutatorSetAltValue : Mutator<NoCompileData>("set_alt_value") {
    override val description = "Sets the alt value to the result of an expression."
    ...
    override val arguments = arguments {
        require(
            ...
            description = "The expression to set the alt value to.",
    ...
    override val parameterTransformers = parameterTransformers {
        adds(TriggerParameter.ALT_VALUE)
    }
    ...
    override fun mutate(data: TriggerData, config: Config, compileData: NoCompileData): TriggerData {
        ...
        return data.copy(
            altValue = config.getDoubleFromExpression("value", data)
        )
    }
}
