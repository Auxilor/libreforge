...
object FilterLpNodeType : Filter<NoCompileData, Collection<String>>("lp_node_type") {
    override val description = "Matches when the LuckPerms node in the trigger is one of the given types."
    override val categories = setOf("permission")
    override val valueType = ArgType.STRING_LIST
    override val additionalInfo = listOf(
        "Requires the LuckPerms plugin.",
        "Valid types are PERMISSION, REGEX_PERMISSION, INHERITANCE, PREFIX, SUFFIX, META, WEIGHT and DISPLAY_NAME.",
    ...
    override fun isMet(data: TriggerData, value: Collection<String>, compileData: NoCompileData): Boolean {
        ...
        return value.containsIgnoreCase(node.type.name())
    }
}
