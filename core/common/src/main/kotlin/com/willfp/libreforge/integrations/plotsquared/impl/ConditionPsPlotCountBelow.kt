...
object ConditionPsPlotCountBelow : Condition<NoCompileData>("ps_plot_count_below") {
    override val description = "Passes when the player owns fewer than the specified number of PlotSquared plots."
    ...
    override val arguments = arguments {
        require(
            ...
            description = "The number of plots the player must have fewer than.",
