...
object EffectFactionAddPoints : Effect<NoCompileData>("faction_add_points") {
    override val parameters = setOf(TriggerParameter.PLAYER)

    override val arguments = arguments {
        require("points", "You must specify the points to add!")
    }
    ...
    override fun onTrigger(config: Config, data: TriggerData, compileData: NoCompileData): Boolean {
        ...
        val amount = config.getIntFromExpression("points", data)
        faction.setPoints(faction.getPoints() + amount)
        return true
    }
}
